function initializeApp() {
    ...
    // Firebase Config (LU UDAH ISI INI DENGAN BENAR)
...
function initializeTracker(db) {
    const SECURE_PASSWORD = 'Botakgila123'; // <--- TAMBAHIN BARIS INI, GANTI DENGAN PASSWORD LU
    ...
    // Fungsi-fungsi anti-fake detection tidak diubah
